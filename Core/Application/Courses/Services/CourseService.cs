...
public class CourseService(IApplicationDbContext dbContext) : ICourseService
{
    ...
    public async Task<List<CourseVm>> GetAllCourses(CancellationToken cancellationToken = default)
    {
    ...
    public async Task<CourseVm> GetCourse(Guid courseId, CancellationToken cancellationToken = default)
    {
