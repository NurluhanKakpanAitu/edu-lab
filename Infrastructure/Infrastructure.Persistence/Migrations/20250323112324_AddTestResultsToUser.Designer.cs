...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250323112324_AddTestResultsToUser")]
    partial class AddTestResultsToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.UserTestResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.UserTestResult", b =>
                {
                    ...
                    b.OwnsOne("System.Collections.Generic.List<Domain.Entities.TestResult>", "TestResults", b1 =>
                        {
                            b1.Property<Guid>("UserTestResultId")
                                .HasColumnType("uuid");

                            b1.Property<int>("Capacity")
                                .HasColumnType("integer");

                            b1.HasKey("UserTestResultId");

                            b1.ToTable("UserTestResults");

                            b1.ToJson("TestResults");
